...
import logo from "../../images/שיר עדי לוגו.png"
...
const NavBarNew = () => {
  ...
  const handleClick = () => {
    const phoneNumber = "+972525776678";
  ...
  const menuItems = ['קורס החלקות' ,'החלקה ביתית', 'שאלות תשובות', 'מי אני'];
  ...
  return (
    <nav className={`${styles.navbar} ${isSticky ? styles.sticky : ''}`}>
      ...
      <div className={styles.socialIcons}>
        <a href="https://www.instagram.com/_shiradi/" target="_blank" rel="noopener noreferrer"><FaInstagram /></a>
